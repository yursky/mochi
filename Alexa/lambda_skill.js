...
const APP_ID = 'amzn1.ask.skill.8022cdd8-0f33-4cd3-a3a8-5715a0094709';  // TODO replace with your app ID (OPTIONAL).
...
const handlers = {
    'LaunchRequest': function () {
        this.emit(':tell', "Welcome to Coco the Care Bot!");
    },
    'GetItem': function () {
        const intentObj = this.event.request.intent;
        
        let itemName = intentObj.slots.itemName.value;

        // Create speech output
        const speechOutput = "I'll have that " + itemName + " out right away!";
    ...
    'GetHelp': function () {
        ...
        // Create speech output
        const speechOutput = "I'll get you help right away!";
        this.emit(':tell', speechOutput);
    },
    'RegisterUser': function () {
        const intentObj = this.event.request.intent;
        
        let uName = intentObj.slots.uName.value;
        ...
        // Create speech output
        const speechOutput = "Thanks for registering, " + uName + "!";
        this.emit(':tell', speechOutput);
    },
